...
const About = () => (
  <div className='Informations About'>
    <p className='About-Header'><b>Cześć!</b></p>
      ...
      <p>Swobodnie czuję się w React, Redux, React-Router, Node.js, ES6, CSS3 i HTML5. Obecnie szukam pracy jako <strong>Front-end developer</strong> (z nastawieniem na React) albo <strong>Full-Stack developer</strong> W dalszych planach mam zamiar poznać Webpack oraz inny back-endowy język programowania (np.: Python albo Java).</p>
